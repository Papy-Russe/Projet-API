...
INSERT INTO flights(id, number, origin, destination, departure_date, departure_time, arrival_date, arrival_time, plane_id) VALUES(NEXTVAL('flights_sequence_database'), 'ABC-4321', 'france', 'england', '2023-11-30','14:45','2023-11-30','16:05',2);--Insertion d'1 vol dans la base de données de vols
